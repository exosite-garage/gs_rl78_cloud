...
extern const uint8_t * Font8x8_subset_table[256];
...
extern const uint8_t * Logos_table[256];
...
******************************************************************************/
typedef enum {
    GLYPH_FONT_8_BY_8,                  // Not Compiled in Library
    GLYPH_FONT_8_BY_8_SUBSET,           // Available       
    GLYPH_FONT_8_BY_16,                 // Not Compiled in Library
    GLYPH_FONT_5_BY_7,                  // Not Compiled in Library
    ...
    GLYPH_FONT_BITMAP,                  // Not Compiled in Library
	GLYPH_FONT_LOGOS                    // Not Compiled in Library
} T_glyphFont ;
